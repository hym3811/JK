...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
		...
		<div class="check">
			<label style="margin-right:5%;"><input type="radio" name="check" value="1">동의</label>
			<label><input type="radio" name="check" value="2">동의하지 않음</label>
		</div>
		<div class="btn">
			<input id="btn" type="button" value="취소" onclick="location.href='../Index/index.jsp'">
